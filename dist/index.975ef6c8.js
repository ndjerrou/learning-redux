...
var _customStoreJs = require("./customStore.js");
var _storeJs = require("./store.js");
var _storeJsDefault = parcelHelpers.interopDefault(_storeJs);
var _actionsJs = require("./actions.js");
const customStore = _customStoreJs.createStore();
console.log(customStore);
console.log(customStore.getState());
_storeJsDefault.default.dispatch(_actionsJs.bugAdded("new bug added right now "));
_storeJsDefault.default.dispatch(_actionsJs.bugAdded("new bug added right before "));
console.log(customStore.getState()); // add a bug
 // 1 - define an action
...
},{"./customStore.js":"bsv05","./actions.js":"4yDTG","./store.js":"d8qyu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bsv05":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createStore", ()=>createStore
);
var _reducerJs = require("./reducer.js");
var _reducerJsDefault = parcelHelpers.interopDefault(_reducerJs);
function createStore() {
    // mock the reduc createStore function
    // 3 props we are interested in : dispatch, getState, subscribe
    let state; //undefined
    let listeners = [];
    function getState() {
        return state;
    ...
    function dispatch(action) {
        // call to the reducer to get the new state
        state = _reducerJsDefault.default(state, action);
...
},{"./reducer.js":"dtSQW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dtSQW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function reducer(state = [], action) {
    ...
    switch(action.type){
        case _actionTypesJs.BUG_ADDED:
            ...
            return newState;
        case _actionTypesJs.BUG_REMOVED:
            return state.filter((bug)=>bug.id !== action.payload.id
            );
        case _actionTypesJs.BUG_RESOLVED:
...
},{"./actionTypes.js":"jjtwk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jjtwk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BUG_ADDED", ()=>BUG_ADDED
);
parcelHelpers.export(exports, "BUG_REMOVED", ()=>BUG_REMOVED
);
parcelHelpers.export(exports, "BUG_RESOLVED", ()=>BUG_RESOLVED
);
const BUG_ADDED = "bugAdded";
const BUG_REMOVED = "bugRemoved";
const BUG_RESOLVED = "bugResolved"; // set a bug as resolved
...
parcelHelpers.defineInteropFlag(exports);
// actions creator
parcelHelpers.export(exports, "bugAdded", ()=>bugAdded
);
parcelHelpers.export(exports, "bugResolved", ()=>bugResolved
);
var _actionTypesJs = require("./actionTypes.js");
function bugAdded(description) {
    return {
        type: _actionTypesJs.BUG_ADDED,
        payload: {
            description
        }
    };
...
function bugResolved(id) {
    return {
        type: _actionTypesJs.BUG_RESOLVED,
        payload: {
            id
        }
    };
...
},{"./actionTypes.js":"jjtwk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8qyu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const store = _redux.createStore(_reducerJsDefault.default, _reduxDevtoolsExtension.devToolsEnhancer({
    trace: true
})); // HOF
exports.default = store;

},{"./reducer.js":"dtSQW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","redux":"cDNB3","redux-devtools-extension":"fOPxo"}],"cDNB3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"redux":"cDNB3"}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequire6330")
